...
## Project Structure
    ...
    ├── testwebsxsasc_dev_43622  # Django project configurations
...
1. Clone this repo and `cd testwebsxsasc_dev_43622`
...
2. Clone this repo and `cd testwebsxsasc_dev_43622`
